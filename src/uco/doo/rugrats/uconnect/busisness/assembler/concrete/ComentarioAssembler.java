...
public final class ComentarioAssembler implements Assembler<ComentarioDomain, ComentarioDTO, ComentarioEntity> {
	...
	public static ComentarioAssembler getInstance() {
		return INSTANCE;
	}
	...
	public ComentarioDTO toDTOFromDomain(ComentarioDomain domain) {
		return ComentarioDTO.create().setIdentificador(domain.getIdentificador())
				.setComentarioPadre(!UtilObject.isNull(domain.getComentarioPadre())
						? ComentarioAssembler.getInstance().toDTOFromDomain(domain.getComentarioPadre())
						: null)
	...
	public ComentarioDomain toDomainFromDTO(ComentarioDTO dto) {
		return new ComentarioDomain(dto.getIdentificador(),
				PublicacionAssembler.getInstance().toDomainFromDTO(dto.getPublicacion()),
				!UtilObject.isNull(dto.getComentarioPadre())
	...
	public ComentarioEntity toEntityFromDomain(ComentarioDomain domain) {
		return new ComentarioEntity(domain.getIdentificador(),
				PublicacionAssembler.getInstance().toEntityFromDomain(domain.getPublicacion()),
				!UtilObject.isNull(domain.getComentarioPadre())
						? ComentarioAssembler.getInstance().toEntityFromDomain(domain.getComentarioPadre())
						: null,
	...
	public ComentarioDomain toDomainFromEntity(ComentarioEntity entity) {
		return new ComentarioDomain(entity.getIdentificador(),
				PublicacionAssembler.getInstance().toDomainFromEntity(entity.getPublicacion()),
				!UtilObject.isNull(entity.getComentarioPadre())
						? ComentarioAssembler.getInstance().toDomainFromEntity(entity.getComentarioPadre())
						: null,
