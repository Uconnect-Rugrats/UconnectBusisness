...
public final class ReporteComentarioFacadeImpl implements ReporteComentarioFacade {
    ...
    public void reportar(ReporteComentarioDTO dto) {
        try {
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.ReporteComentarioFacadeImplMessages.USER_MESSAGE_REGISTER;
            var technicalMessage = Messages.ReporteComentarioFacadeImplMessages.TECHNICAL_MESSAGE_REGISTER;
    ...
    public void cambiarEstado(ReporteComentarioDTO dto) {
        try {
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.ReporteComentarioFacadeImplMessages.USER_MESSAGE_MODIFY;
            var technicalMessage = Messages.ReporteComentarioFacadeImplMessages.TECHNICAL_MESSAGE_MODIFY;
    ...
    public List<ReporteComentarioDTO> abrir(ReporteComentarioDTO dto) {
        try {
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.ReporteComentarioFacadeImplMessages.USER_MESSAGE_LIST;
            var technicalMessage = Messages.ReporteComentarioFacadeImplMessages.TECHNICAL_MESSAGE_LIST;
    ...
    public EstadoDTO obtenerEstadoReal() {
        try {
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.ReporteComentarioFacadeImplMessages.USER_MESSAGE_STATE;
            var technicalMessage = Messages.ReporteComentarioFacadeImplMessages.TECHNICAL_MESSAGE_STATE;
