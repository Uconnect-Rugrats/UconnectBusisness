...
public final class AdministradorEstructuraFacadeImpl implements AdministradorEstructuraFacade {
    ...
    public void concederPermisos(AdministradorEstructuraDTO dto) {
        try {
            ...
            final AdministradorEstructuraDomain domain = AdministradorEstructuraAssembler.getInstance().toDomainFromDTO(dto);
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.AdministradorEstructuraFacadeImplMessages.USER_MESSAGE_REGISTER;
            var technicalMessage = Messages.AdministradorEstructuraFacadeImplMessages.TECHNICAL_MESSAGE_REGISTER;
    ...
    public void cambiarEstado(AdministradorEstructuraDTO dto) {
        try {
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.AdministradorEstructuraFacadeImplMessages.USER_MESSAGE_MODIFY;
            var technicalMessage = Messages.AdministradorEstructuraFacadeImplMessages.TECHNICAL_MESSAGE_MODIFY;
    ...
    public List<AdministradorEstructuraDTO> consultar(AdministradorEstructuraDTO dto) {
        try {
            daoFactory.initTransaction();
            final AdministradorEstructuraDomain domainList = AdministradorEstructuraAssembler.getInstance().toDomainFromDTO(dto);
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.AdministradorEstructuraFacadeImplMessages.USER_MESSAGE_LIST;
            var technicalMessage = Messages.AdministradorEstructuraFacadeImplMessages.TECHNICAL_MESSAGE_LIST;
    ...
    public void eliminar(UUID dto) {
        try {
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.AdministradorOrganizacionFacadeImplMessages.USER_MESSAGE_DROP;
            var technicalMessage = Messages.AdministradorOrganizacionFacadeImplMessages.TECHNICAL_MESSAGE_DROP;
    ...
    public EstadoDTO obtenerEstadoReal() {
        try {
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.AdministradorEstructuraFacadeImplMessages.USER_MESSAGE_STATE;
            var technicalMessage = Messages.AdministradorEstructuraFacadeImplMessages.TECHNICAL_MESSAGE_STATE;
