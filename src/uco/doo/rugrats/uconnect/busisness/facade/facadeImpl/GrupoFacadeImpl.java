...
public final class GrupoFacadeImpl implements GrupoFacade {
    ...
    public void crear(GrupoDTO dto) {
        try {
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.GrupoFacadeImplMessages.USER_MESSAGE_REGISTER;
            var technicalMessage = Messages.GrupoFacadeImplMessages.TECHNICAL_MESSAGE_REGISTER;
    ...
    public void editar(GrupoDTO dto) {
        try {
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.GrupoFacadeImplMessages.USER_MESSAGE_MODIFY;
            var technicalMessage = Messages.GrupoFacadeImplMessages.TECHNICAL_MESSAGE_MODIFY;
    ...
    public List<GrupoDTO> buscar(GrupoDTO dto) {
        try {
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.GrupoFacadeImplMessages.USER_MESSAGE_LIST;
            var technicalMessage = Messages.GrupoFacadeImplMessages.TECHNICAL_MESSAGE_LIST;
    ...
    public void eliminar(UUID dto) {
        try {
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.GrupoFacadeImplMessages.USER_MESSAGE_DROP;
            var technicalMessage = Messages.GrupoFacadeImplMessages.TECHNICAL_MESSAGE_DROP;
    ...
    public EstadoDTO obtenerEstadoReal() {
        try {
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.GrupoFacadeImplMessages.USER_MESSAGE_STATE;
            var technicalMessage = Messages.GrupoFacadeImplMessages.TECHNICAL_MESSAGE_STATE;
