...
public final class RespuestaReportePublicacionFacadeImpl implements RespuestaReportePublicacionFacade {
    ...
    public void revisar(RespuestaReportePublicacionDTO dto) {
        try {
            ...
            final RespuestaReportePublicacionDomain domain = RespuestaReportePublicacionAssembler.getInstance().toDomainFromDTO(dto);
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.RespuestaReportePublicacionFacadeImplMessages.USER_MESSAGE_REGISTER;
            var technicalMessage = Messages.RespuestaReportePublicacionFacadeImplMessages.TECHNICAL_MESSAGE_REGISTER;
    ...
    public void cerrarRespuesta(RespuestaReportePublicacionDTO dto) {
        try {
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.RespuestaReportePublicacionFacadeImplMessages.USER_MESSAGE_MODIFY;
            var technicalMessage = Messages.RespuestaReportePublicacionFacadeImplMessages.TECHNICAL_MESSAGE_MODIFY;
    ...
    public List<RespuestaReportePublicacionDTO> abrir(RespuestaReportePublicacionDTO dto) {
        try {
            daoFactory.initTransaction();
            final RespuestaReportePublicacionDomain domainList = RespuestaReportePublicacionAssembler.getInstance().toDomainFromDTO(dto);
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.RespuestaReportePublicacionFacadeImplMessages.USER_MESSAGE_LIST;
            var technicalMessage = Messages.RespuestaReportePublicacionFacadeImplMessages.TECHNICAL_MESSAGE_LIST;
    ...
    public void eliminar(UUID dto) {
        try {
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.RespuestaReportePublicacionFacadeImplMessages.USER_MESSAGE_DROP;
            var technicalMessage = Messages.RespuestaReportePublicacionFacadeImplMessages.TECHNICAL_MESSAGE_DROP;
    ...
    public EstadoDTO obtenerEstadoReal() {
        try {
            ...
            daoFactory.rollbackTransaction();
            var userMessage = Messages.RespuestaReportePublicacionFacadeImplMessages.USER_MESSAGE_STATE;
            var technicalMessage = Messages.RespuestaReportePublicacionFacadeImplMessages.TECHNICAL_MESSAGE_STATE;
