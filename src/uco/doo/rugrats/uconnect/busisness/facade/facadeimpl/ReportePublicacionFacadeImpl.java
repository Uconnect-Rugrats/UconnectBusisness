...
public final class ReportePublicacionFacadeImpl implements ReportePublicacionFacade {
	...
	public EstadoDTO obtenerEstadoReal() {
		try {
			...
			daoFactory.rollbackTransaction();
			throw UconnectBusisnessException.create(
					UconnectBusinessMessages.Facade.ReportePublicacionFacadeImplMessages.TECHNICAL_MESSAGE_STATE,
					UconnectBusinessMessages.Facade.ReportePublicacionFacadeImplMessages.USER_MESSAGE_STATE, exception);
		} finally {
			daoFactory.closeConnection();
		}
	}
