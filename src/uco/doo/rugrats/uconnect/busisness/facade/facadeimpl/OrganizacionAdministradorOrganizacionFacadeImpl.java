...
public final class OrganizacionAdministradorOrganizacionFacadeImpl
	...
	public EstadoDTO obtenerEstadoReal() {
		try {
			...
			daoFactory.rollbackTransaction();
			throw UconnectBusisnessException.create(
					UconnectBusinessMessages.Facade.OrganizacionAdministradorOrganizacionFacadeImplMessages.TECHNICAL_MESSAGE_STATE,
					UconnectBusinessMessages.Facade.OrganizacionAdministradorOrganizacionFacadeImplMessages.USER_MESSAGE_STATE,
					exception);
		} finally {
			daoFactory.closeConnection();
		}
