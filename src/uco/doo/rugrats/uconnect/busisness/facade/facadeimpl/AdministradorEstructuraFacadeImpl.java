...
public final class AdministradorEstructuraFacadeImpl implements AdministradorEstructuraFacade {
	...
	public EstadoDTO obtenerEstadoReal() {
		try {
			...
			daoFactory.rollbackTransaction();
			throw UconnectBusisnessException.create(
					UconnectBusinessMessages.Facade.AdministradorEstructuraFacadeImplMessages.TECHNICAL_MESSAGE_STATE,
					UconnectBusinessMessages.Facade.AdministradorEstructuraFacadeImplMessages.USER_MESSAGE_STATE,
					exception);
		} finally {
			daoFactory.closeConnection();
		}
