...
public final class HistorialChatGrupoFacadeImpl implements HistorialChatGrupoFacade {
	...
	public EstadoDTO obtenerEstadoReal() {
		try {
			...
			daoFactory.rollbackTransaction();
			throw UconnectBusisnessException.create(
					UconnectBusinessMessages.Facade.HistorialChatGrupoFacadeImplMessages.TECHNICAL_MESSAGE_STATE,
					UconnectBusinessMessages.Facade.HistorialChatGrupoFacadeImplMessages.USER_MESSAGE_STATE, exception);
		} finally {
			daoFactory.closeConnection();
		}
	}
