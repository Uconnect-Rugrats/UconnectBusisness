...
public final class RespuestaReportePublicacionDomain {
    ...
    public RespuestaReportePublicacionDomain(final UUID identificador, final LocalDateTime fechaRespuesta, final ReportePublicacionDomain reporte, final EstadoDomain estado, final String explicacionVeredicto, final EstructuraAdministradorEstructuraDomain administrador) {
        super();
