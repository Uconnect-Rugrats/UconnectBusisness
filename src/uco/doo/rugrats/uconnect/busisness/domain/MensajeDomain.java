...
public final class MensajeDomain {
	...
	public MensajeDomain(final UUID identificador, final ChatDomain chat, final ParticipanteGrupoDomain autor,
			final LocalDateTime fechaEnviado, final String contenido, final EstadoDomain estado) {
		super();
