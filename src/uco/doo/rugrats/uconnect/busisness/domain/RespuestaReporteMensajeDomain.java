...
public final class RespuestaReporteMensajeDomain {
	...
	public RespuestaReporteMensajeDomain(final UUID identificador, final LocalDateTime fechaRespuesta,
			final ReporteMensajeDomain reporte, final EstadoDomain estado, final String explicacionVeredicto,
