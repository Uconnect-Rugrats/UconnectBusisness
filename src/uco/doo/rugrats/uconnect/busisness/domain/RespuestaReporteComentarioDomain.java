...
public final class RespuestaReporteComentarioDomain {
	...
	public RespuestaReporteComentarioDomain(final UUID identificador, final LocalDateTime fechaRespuesta,
			final ReporteComentarioDomain reporte, final EstadoDomain estado, final String explicacionVeredicto,
