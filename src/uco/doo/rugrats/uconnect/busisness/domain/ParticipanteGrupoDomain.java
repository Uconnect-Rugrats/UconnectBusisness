...
public final class ParticipanteGrupoDomain {
    ...
    public ParticipanteGrupoDomain(final UUID identificador, final ParticipanteDomain participante, final Boolean puedePublicar, final GrupoDomain grupo, final EstadoDomain estado) {
        super();
